<template>
  <div class="view row d-flex justify-content-center m-auto">
    <div class="p-0">
      <Banner
        :headline="'Für den reibungslosen Einbau empfehlen wir unsere Premium-Baustoffe!'"
        :sealsEnabled="false"
      />
      <div style="">
        <div class="d-flex justify-content-center mt-4 pt-4">
          <h1>Baustoffe für die Selbstmontage</h1>
        </div>
        <div
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <div class="d-flex justify-content-evenly">
                <card :priceStarts="false" /><card :priceStarts="false" /><card
                  :priceStarts="false"
                /><card :priceStarts="false" /><card :priceStarts="false" />
              </div>
            </div>
