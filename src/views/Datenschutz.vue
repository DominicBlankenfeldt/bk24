<template>
  <div class="datenschutz row d-flex justify-content-center m-auto mt-4">
    <div class="headline col-12 d-flex justify-content-center mt-4 p-1 mb-3">
      Datenschutz
    </div>
    <div>
      <div class="m-2">
        <div class="mb-4">
          ...
          Geschäftsleitung der Baukoenig24 UG (haftungsbeschränkt). Eine Nutzung
          der Internetseiten der Baukoenig24 UG (haftungsbeschränkt) ist
          ...
          eine Einwilligung der betroffenen Person ein. <br />
          ...
          und in Übereinstimmung mit den für die Baukoenig24 UG
          ...
          Die Baukoenig24 UG (haftungsbeschränkt) hat als für die Verarbeitung
        ...
        Die Datenschutzerklärung der Baukoenig24 UG (haftungsbeschränkt) beruht
        ...
        <h3 class="mt-3">a) personenbezogene Daten</h3>
        ...
        betroffene Person
        <h3 class="mt-3">b) betroffene Person</h3>
        ...
        <h3 class="mt-3">c) Verarbeitung</h3>
        ...
        Vernichtung.
        <h3 class="mt-3">d) Einschränkung der Verarbeitung</h3>
        Einschränkung der Verarbeitung ist die Markierung gespeicherter
        personenbezogener Daten mit dem Ziel, ihre künftige Verarbeitung
        einzuschränken.
        <h3 class="mt-3">e) Profiling</h3>
        ...
        oder vorherzusagen.
        <h3 class="mt-3">f) Pseudonymisierung</h3>
        ...
        <h3 class="mt-3">h) Auftragsverarbeiter</h3>
        ...
        verarbeiten.
        <h3 class="mt-3">k) Einwilligung</h3>
        ...
        Baukoenig24 UG (haftungsbeschränkt) Kieler Str. 4a 24247 Mielkendorf
        Deutschland Tel.: 04347 / 901 03 47 E-Mail: info@baukoenig24.de Website:
        www.baukoenig24.de
        <h2 class="mt-3">3. Cookies</h2>
        Die Internetseiten der Baukoenig24 UG (haftungsbeschränkt) verwenden
        Cookies. Cookies sind Textdateien, welche über einen Internetbrowser auf
        ...
        die eindeutige Cookie-ID wiedererkannt und identifiziert werden. Durch
        den Einsatz von Cookies kann die Baukoenig24 UG (haftungsbeschränkt) den
        ...
        können die Informationen und Angebote auf unserer Internetseite im Sinne
        ...
        Die Internetseite der Baukoenig24 UG (haftungsbeschränkt) erfasst mit
        ...
        Nutzung dieser allgemeinen Daten und Informationen zieht die Baukoenig24
        UG (haftungsbeschränkt) keine Rückschlüsse auf die betroffene Person.
        ...
        erhobenen Daten und Informationen werden durch die Baukoenig24 UG
        ...
        <h2 class="mt-3">5. Kontaktmöglichkeit über die Internetseite</h2>
        Die Internetseite der Baukoenig24 UG (haftungsbeschränkt) enthält
        aufgrund von gesetzlichen Vorschriften Angaben, die eine schnelle
        ...
        oder gelöscht.
        <h2 class="mt-3">7. Rechte der betroffenen Person</h2>
        <h3 class="mt-3">a) Recht auf Bestätigung</h3>
        ...
        <h3 class="mt-3">b) Recht auf Auskunft</h3>
        ...
        folgende Informationen zugestanden: die Verarbeitungszwecke die
        Kategorien personenbezogener Daten, die verarbeitet werden die Empfänger
        ...
        für die Festlegung dieser Dauer das Bestehen eines Rechts auf
        ...
        Beschwerderechts bei einer Aufsichtsbehörde wenn die personenbezogenen
        Daten nicht bei der betroffenen Person erhoben werden: Alle verfügbaren
        Informationen über die Herkunft der Daten das Bestehen einer
        ...
        Verarbeitung für die betroffene Person Ferner steht der betroffenen
        ...
        <h3 class="mt-3">c) Recht auf Berichtigung</h3>
        Jede von der Verarbeitung personenbezogener Daten betroffene Person hat
        das vom Europäischen Richtlinien- und Verordnungsgeber gewährte Recht,
        ...
        sich hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung
        Verantwortlichen wenden.
        <h3 class="mt-3">d) Recht auf Löschung (Recht auf Vergessen werden)</h3>
        Jede von der Verarbeitung personenbezogener Daten betroffene Person hat
        das vom Europäischen Richtlinien- und Verordnungsgeber gewährte Recht,
        ...
        ist: Die personenbezogenen Daten wurden für solche Zwecke erhoben oder
        ...
        Rechtsgrundlage für die Verarbeitung. Die betroffene Person legt gemäß
        ...
        unrechtmäßig verarbeitet. Die Löschung der personenbezogenen Daten ist
        ...
        unterliegt. Die personenbezogenen Daten wurden in Bezug auf angebotene
        ...
        Person die Löschung von personenbezogenen Daten, die bei der Baukoenig24
        UG (haftungsbeschränkt) gespeichert sind, veranlassen möchte, kann sie
        sich hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung
        Verantwortlichen wenden. Der Mitarbeiter der Baukoenig24 UG
        ...
        der Baukoenig24 UG (haftungsbeschränkt) öffentlich gemacht und ist unser
        ...
        Baukoenig24 UG (haftungsbeschränkt) unter Berücksichtigung der
        ...
        Baukoenig24 UG (haftungsbeschränkt) wird im Einzelfall das Notwendige
        veranlassen.
        <h3 class="mt-3">e) Recht auf Einschränkung der Verarbeitung</h3>
        Jede von der Verarbeitung personenbezogener Daten betroffene Person hat
        das vom Europäischen Richtlinien- und Verordnungsgeber gewährte Recht,
        von dem Verantwortlichen die Einschränkung der Verarbeitung zu
        verlangen, wenn eine der folgenden Voraussetzungen gegeben ist: Die
        ...
        Person überwiegen. Sofern eine der oben genannten Voraussetzungen
        gegeben ist und eine betroffene Person die Einschränkung von
        personenbezogenen Daten, die bei der Baukoenig24 UG (haftungsbeschränkt)
        ...
        Mitarbeiter der Baukoenig24 UG (haftungsbeschränkt) wird die
        Einschränkung der Verarbeitung veranlassen.
        <h3 class="mt-3">f) Recht auf Datenübertragbarkeit</h3>
        Jede von der Verarbeitung personenbezogener Daten betroffene Person hat
        das vom Europäischen Richtlinien- und Verordnungsgeber gewährte Recht,
        ...
        betroffene Person jederzeit an einen Mitarbeiter der Baukoenig24 UG
        (haftungsbeschränkt) wenden.
        <h3 class="mt-3">g) Recht auf Widerspruch</h3>
        Jede von der Verarbeitung personenbezogener Daten betroffene Person hat
        das vom Europäischen Richtlinien- und Verordnungsgeber gewährte Recht,
        ...
        gestütztes Profiling. Die Baukoenig24 UG (haftungsbeschränkt)
        ...
        Verarbeitet die Baukoenig24 UG (haftungsbeschränkt) personenbezogene
        ...
        Baukoenig24 UG (haftungsbeschränkt) der Verarbeitung für Zwecke der
        Direktwerbung, so wird die Baukoenig24 UG (haftungsbeschränkt) die
        personenbezogenen Daten nicht mehr für diese Zwecke verarbeiten. Zudem
        ...
        personenbezogener Daten, die bei der Baukoenig24 UG (haftungsbeschränkt)
        ...
        direkt an jeden Mitarbeiter der Baukoenig24 UG (haftungsbeschränkt) oder
        ...
        Einwilligung der betroffenen Person, trifft die Baukoenig24 UG
        (haftungsbeschränkt) angemessene Maßnahmen, um die Rechte und Freiheiten
        ...
        Anfechtung der Entscheidung gehört. Möchte die betroffene Person Rechte
        ...
        Wirtschaftsraum erfolgt. Der Zweck der Google-Analytics-Komponente ist
        die Analyse der Besucherströme auf unserer Internetseite. Google nutzt
        die gewonnenen Daten und Informationen unter anderem dazu, die Nutzung
        ...
        sind, wurde oben bereits erläutert. Mit Setzung des Cookies wird Google
        eine Analyse der Benutzung unserer Internetseite ermöglicht. Durch jeden
        Aufruf einer der Einzelseiten dieser Internetseite, die durch den für
        ...
        personenbezogenen Daten unter Umständen an Dritte weiter. Die betroffene
        Person kann die Setzung von Cookies durch unsere Internetseite, wie oben
        ...
        Aktivierung des Browser-Add-Ons. Weitere Informationen und die geltenden
        ...
        <h2 class="mt-3">10. Rechtsgrundlage der Verarbeitung</h2>
        ...
        mehr zur Vertragserfüllung oder Vertragsanbahnung erforderlich sind.13.
        ...
        Nichtbereitstellung der personenbezogenen Daten hätte. 15. Bestehen
        einer automatisierten Entscheidungsfindung Als verantwortungsbewusstes
        Unternehmen verzichten wir auf eine automatische Entscheidungsfindung
        oder ein Profiling.
      </div>
    </div>
  </div>
